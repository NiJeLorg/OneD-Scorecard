...
function refreshPinwheelsByYearMap() {
	// function to set up crossfilter dimensions
	// set a global variable for crossfilter on the dataset
	var cf = crossfilter(dataset);	
	var byGeoID = setupCrossfilterByGeoID(cf, dataset);
...
function refreshPinwheelsByYearArray() {
	// function to set up crossfilter dimensions
	// set a global variable for crossfilter on the dataset
	var cf = crossfilter(dataset);	
	var byGeoID = setupCrossfilterByGeoID(cf, dataset);
	...
	// update slider
	year = parseInt(year);
	$( "#pinwheelSlider" ).slider( 'setValue', year );
	
	// update dropdown
	$( ".pinwheelChangeArray" ).val( '1' );
