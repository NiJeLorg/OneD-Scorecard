function cityCircularHeatChart() {
    ...
    radialLabels = segmentLabels = ids = datasetIndicators = [];
    ...
    chart.datasetIndicators = function(_) {
        if (!arguments.length) return datasetIndicators;
        if (_ == null) _ = [];
        datasetIndicators = _;
        return chart;
    };
