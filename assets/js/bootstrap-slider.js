	...
	var Slider = function(element, options) {
		...
		switch(this.orientation) {
			...
			default:
				...
				this.tooltip.addClass('top')[0].style.top = -25 + 'px';
				this.tooltip_min.addClass('top')[0].style.top = -25 + 'px';
				this.tooltip_max.addClass('top')[0].style.top = 18 + 'px';
				break;
		}
		...
		//setting offset manually for this project
		/*
		this.picker[0]['offsetHeight'] = 20;
		this.picker[0]['offsetLeft'] = 345;
		this.picker[0]['offsetTop'] = 513;
		this.picker[0]['offsetWidth'] = 150;
		*/

		this.offset = this.picker.offset();
		//this.size = this.picker[0][this.sizePos];
		// hardcoding this.size to have the tooltip work for this project
		this.size = 150;
